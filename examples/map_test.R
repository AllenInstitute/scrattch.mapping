...
taxonomies = c("/allen/programs/celltypes/workgroups/rnaseqanalysis/EvoGen/shinymap_test",
               "/allen/programs/celltypes/workgroups/rnaseqanalysis/shiny/10x_seq/human_BGplus_20211020")
...
for(taxonomy in taxonomies){
    ...
    mapping.anno[[taxonomy]] = taxonomy_mapping(AIT.anndata=AIT.anndata, seurat.map=FALSE, query.data=query.data, label.cols="cluster_label")
}
