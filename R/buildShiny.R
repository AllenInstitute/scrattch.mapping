                                                ...
                                                )
{
  ...
  if(generateUMAP){
    ...
    seurat.obj <- RunUMAP(object = seurat.obj, dims = npcs, verbose=FALSE)
  }
...
#'
#' @export
buildReferenceFolder = function(seurat.obj, shinyFolder, subsample=2000, feature.set=NULL){
    ...
    tpm.matrix = GetAssayData(seurat.obj, "data", assay="RNA")
    ...
    ### Convert chars and factors to characters
    ...
    ## Write the desc and meta.data files.  
    ...
    anno = meta.data
    write_feather(anno, file.path(shinyFolder,"anno.feather"))

    ## Write the UMAP coordinates.  
    print("===== Building umap/tsne feathers =====")
    ...
    for (i in 1:length(all_clusters)) {
        ...
        cluster_samples = meta.data$cluster_id[which(meta.data$cluster_id == cluster)]
