...
dend <- addDendrogramMarkers(dend      = readRDS(file.path(refFolder,"dend.RData")), 
                             norm.data = file.path(refFolder,"data_t.feather"),
                             metadata  = file.path(refFolder,"anno.feather"),
                             shinyFolder = refFolder, 
...
```{r patchseqQC set up}
writePatchseqQCmarkers(counts = file.path(refFolder,"counts.feather"),  # can also read matrix directly
                       metadata = file.path(refFolder,"anno.feather"),  # can also read matrix directly
