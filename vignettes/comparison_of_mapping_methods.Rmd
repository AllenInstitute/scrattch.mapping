---
title: "Comparing multiple mapping methods"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteIndexEntry{Comparing multiple mapping methods}
...
**The vignette "Map patch-seq data and output directory" must be run prior to running this vignette, as the output reference taxonomy files are required for mapping.**

We compare a total of 4 clustering/mapping methods, all of which are implememted as part of `scrattch-mapping`:  
...
for (i in 1:3){
  compare_heatmap(map[[i]],clust,xlab="Tree mapping",ylab="Clustering", cex.lab=0.3)
}
```   
